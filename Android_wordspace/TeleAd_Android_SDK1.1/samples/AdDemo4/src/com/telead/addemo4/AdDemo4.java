...
public class AdDemo4 extends Activity implements AdListener{
	LinearLayout adlayout;
	String TAG = "Telead SDK AdDemo4";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adView = new ImpressionAdView(this, // Context
				adlayout, // View 及View的子类 即可
				"b2b1c3a80f1a4d6f87dac85ee9a05c7e", //Telead_PID
				x,  // 广告显示左上角 x 位置
				y, // 广告显示左上角 y 位置
				Color.WHITE, // 广告文字颜色
